...
function thinktrees_customize_register( $wp_customize ) {
...
add_action('customize_register', 'thinktrees_customize_register');



// Output Customize CSS
function thinktrees_customize_css() { ?>
...
add_action('wp_head', 'thinktrees_customize_css');
